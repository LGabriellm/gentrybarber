...
import { MinimalTheme, minimalTokens } from "./standard/minimal";
...
export const themeRegistry = new ThemeRegistry([
  ...
  { id: "minimal", name: "Minimal", description: "Preto e branco, sem decoração. Foco absoluto no conteúdo e nas fotografias.", kind: "TEMPLATE", Renderer: MinimalTheme, tokens: minimalTokens, capabilities: ["colors", "typography", "services", "professionals"], requiredFeatures: [] },
